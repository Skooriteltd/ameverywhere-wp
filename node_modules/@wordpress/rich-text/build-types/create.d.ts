 ...
 */
export declare function create({ element, text, html, range, __unstableIsEditableTree: isEditableTree }?: {
    element?: Element;
    text?: string;
    html?: string;
    range?: Range;
 ...
 * @param {string} string
 */
export declare function removeReservedCharacters(string: string): string;
