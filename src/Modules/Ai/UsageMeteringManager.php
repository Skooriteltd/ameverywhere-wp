...
class UsageMeteringManager
{
    ...
    public function boot(): void
    {
        ...
        add_action(self::CRON_HOOK, [$this, 'sendWeeklySummary']);
    ...
    {
        register_rest_route('ameverywhere/v1', '/ai/usage', [
            'methods'             => \WP_REST_Server::READABLE,
            'callback'            => [$this, 'getMyUsage'],
            'permission_callback' => fn() => is_user_logged_in(),
        ]);

        register_rest_route('ameverywhere/v1', '/ai/usage/site', [
            'methods'             => \WP_REST_Server::READABLE,
            'callback'            => [$this, 'getSiteUsageEndpoint'],
            'permission_callback' => fn() => current_user_can('manage_options'),
        ]);

        register_rest_route('ameverywhere/v1', '/ai/usage/limits', [
            [
                'methods'             => \WP_REST_Server::READABLE,
    ...
    public function saveLimits(\WP_REST_Request $request): \WP_REST_Response
    {
        ...
        return rest_ensure_response(['success' => true, 'limits' => $limits]);
    }
    ...
    public function sendWeeklySummary(): void
    {
        ...
        wp_mail($admin, $subject, $body, ['Content-Type: text/html; charset=UTF-8']);
    }
    ...
    {
        return ['free' => 50000, 'pro' => 500000, 'enterprise' => 5000000];
    }
