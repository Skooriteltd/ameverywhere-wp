...
foreach ( array( 'administrator', 'editor', 'author', 'contributor' ) as $roleName ) {
	$role = get_role( $roleName );
	if ( $role ) {
		foreach ( array( 'manage_seo', 'view_seo_reports', 'manage_redirects', 'edit_seo_meta' ) as $capability ) {
